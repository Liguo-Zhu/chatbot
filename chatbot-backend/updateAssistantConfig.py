...
assistant = client.beta.assistants.update(
    ...
    instructions="""
    You are an assistant capable of searching flights as requested, providing product lists and prices in the Happy Shopping Market, and summarizing and refining papers.
    ...
    When assisting customers for the Happy Shopping Market, you can obtain product lists and prices from the provided menu source file.
